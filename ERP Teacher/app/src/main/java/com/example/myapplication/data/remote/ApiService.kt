...
interface ApiService {
    ...
    suspend fun getParentChildren(@Header("Authorization") token: String): Response<List<ParentChildData>>
    ...
    suspend fun submitParentLeave(
        @Header("Authorization") token: String,
        @Path("studentId") studentId: String,
        @Body request: ParentSubmitLeaveRequest
    ): Response<com.google.gson.JsonObject>

    @GET("api/parent/children/{studentId}/leave")
    suspend fun getParentLeaveHistory(
        @Header("Authorization") token: String,
        @Path("studentId") studentId: String
    ...
    suspend fun getParentNotices(@Header("Authorization") token: String): Response<List<ParentNoticeItem>>
