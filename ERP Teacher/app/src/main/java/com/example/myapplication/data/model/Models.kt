...
data class ParentLoginResponse(val token: String, val children: List<ParentChildData>)
...
data class ParentSubmitLeaveRequest(val fromDate: String, val toDate: String, val reason: String)
